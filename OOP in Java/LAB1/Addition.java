   ...
   */
   {
           ...
           int add;                                 //simple declearing variable
           add=num1+num2;                           //performing calculations
           System.out.println("First Number is:"+num1+"\nSecond Number is:"+num2);//display on output screen
           System.out.println("Addition is:"+add);//display on output screen
           t.close(); //important close the scanner
   }
}
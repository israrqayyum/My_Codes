...
import java.util.Scanner;   //scanner function for getting data in input screen
   public class Reminder    //class decleration
   {
        ...
        */
       {
           ...
           int rem;                                 //simple declearing variable
           rem=num1%num2;                           //performing calculations
           System.out.println("First Number is:"+num1+"\nSecond Number is:"+num2);//display on output screen
           System.out.println("Reminder is:"+rem);//display on output screen
           t.close();
        }
   }
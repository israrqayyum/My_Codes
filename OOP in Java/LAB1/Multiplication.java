...
import java.util.Scanner;   //scanner function for getting data in input screen
   public class Multiplication //class decleration
   {
        ...
        */
       {
           ...
           int multi;                               //simple declearing variable
           multi=num1*num2;                         //performing calculations
           System.out.println("First Number is:"+num1+"\nSecond Number is:"+num2);//display on output screen
           System.out.println("Multiplication is:"+multi);//display on output screen
           t.close();
        }
   }